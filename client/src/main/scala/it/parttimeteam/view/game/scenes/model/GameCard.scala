...
import it.parttimeteam.view.utils.{CardUtils, ImagePaths}
...
object GameCard {
  ...
  class GameCardImpl(private val card: Card, cardListener: CardListener) extends GameCard {
    ...
    override def setAsBoardCard(): Unit = {
      val prohibitionIcon: ImageView = new ImageView(new Image(ImagePaths.PROHIBITION_SIGN, 15, 15, false, false))
